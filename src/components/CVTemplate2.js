...
const CVTemplate2 = forwardRef(({ data, color }, ref) => {
  const {
    name,
    title,
    photo,
  ...
  {socialLinks?.github && (
    <div className="flex items-center gap-3">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="text-white hover:text-gray-300 transition-all duration-200 underline break-all"
      >
        {socialLinks.github}
      </a>
    </div>
      ...
      {education.map((edu, i) => {
        ...
        return hasContent ? (
          <div key={i} className="mb-4">
            ...
            <p className="text-md text-gray-800">{edu.institution} </p>
